            ...
            <div class="w-full p-6 flex flex-col items-center gap-8 my-6 ">
                ...
                <div class="bg-white rounded-lg shadow-2xl lg:flex lg:max-w-lg">
                    ...
                    <div class="p-6 flex gap-4 flex-col">
                        ...
                        <a href="{{ url('users') }}" class="p-4 bg-blue-900 text-white text-center rounded-md md:w-28 w-full hover:bg-blue-800 hover:scale-105 transition-all duration-500">
                           Admin
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-2xl lg:flex lg:max-w-lg">
                    ...
                    <div class="p-6 flex gap-4 flex-col">
                        ...
                        <a href="{{ url('categories') }}" class="p-4 bg-blue-900 text-white text-center rounded-md md:w-28 w-full hover:bg-blue-800 hover:scale-105 transition-all duration-500">
                           Admin
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-2xl lg:flex lg:max-w-lg">
                    ...
                    <div class="p-6 flex gap-4 flex-col">
                        ...
                        <a href="{{ url('games') }}" class="p-4 bg-blue-900 text-white text-center rounded-md md:w-28 w-full hover:bg-blue-800 hover:scale-105 transition-all duration-500">
                           Admin
                        </a>
                    </div>
                </div>
