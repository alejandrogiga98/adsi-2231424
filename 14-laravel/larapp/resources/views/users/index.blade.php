...
@section('content')
   ...
   <h1 class="text-center mt-10 mb-6 text-2xl font-bold">Module Users</h1>
   <a href="{{ url('users/create') }}" class="bg-gray-500 text-white py-2 px-6 rounded-md my-8 w-88 mx-auto">Add User</a>
   @if (session('message'))
