...
<main class="sm:container sm:mx-auto sm:max-w-lg sm:mt-10">
    <div class="flex">
        <div class="w-full">
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-lg mx-auto">
            ...
            <nav class="flex items-center justify-center py-4" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <div class="flex items-center">
                        ...
                        <a href="{{ url('categories') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Categories Module</a>
                    </div>
                    </li>
                    <li>
                    <div class="flex items-center">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="flex flex-wrap items-center justify-center bordered  border-2 rounded-lg @error('image') border-red-500 @enderror">
