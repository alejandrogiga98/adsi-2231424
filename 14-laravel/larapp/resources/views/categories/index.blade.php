...
@section('content')
    ...
    <div class="p-4">
        ...
        <div class="relative mt-1 flex gap-2 items-center">
            ...
            <a href="{{ url('export/categories/pdf') }}" class="bg-red-800 text-white rounded-md p-2 my-5 w-40 flex gap-2 items-center hover:bg-green-600 hover:scale-105 transition-all duration-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V7.414A2 2 0 0015.414 6L12 2.586A2 2 0 0010.586 2H6zm5 6a1 1 0 10-2 0v3.586l-1.293-1.293a1 1 0 10-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 11.586V8z" clip-rule="evenodd" />
                </svg>
                <span class="sm:block hidden">Export PDF</span>
            </a>
            <a href="{{ url('export/categories/excel') }}" class="bg-red-800 text-white rounded-md p-2 my-5 w-40 flex gap-2 items-center hover:bg-green-600 hover:scale-105 transition-all duration-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V7.414A2 2 0 0015.414 6L12 2.586A2 2 0 0010.586 2H6zm2 10a1 1 0 10-2 0v3a1 1 0 102 0v-3zm2-3a1 1 0 011 1v5a1 1 0 11-2 0v-5a1 1 0 011-1zm4-1a1 1 0 10-2 0v7a1 1 0 102 0V8z" clip-rule="evenodd" />
                </svg>
                <span class="sm:block hidden">Export Excel</span>
            </a>
            <form action="{{ url('import/categories') }}" class="" method="post" enctype="multipart/form-data">
                @csrf
            ...
            <!-- <a href="{{ url('import/categories') }}" class="bg-red-800 text-white rounded-md p-2 my-5 w-40 flex gap-2 items-center hover:bg-green-600 hover:scale-105 transition-all duration-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V7.414A2 2 0 0015.414 6L12 2.586A2 2 0 0010.586 2H6zm5 6a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V8z" clip-rule="evenodd" />
                </svg>
                <span class="sm:block hidden">Import Excel</span>
    ...
    <table class="table w-full text-sm text-left text-gray-500">
        ...
        <tbody id="content">
            ...
            <tr class="bg-white border-b hover:bg-gray-50">
                ...
                <td class="px-6 py-4 md:table-cell hidden">
                    <img src="{{ asset($category->image) }}" alt="" width="60px" height="60px" class="rounded-xl">
                </td>
